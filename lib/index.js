...
const isAllowedModule  = require('./core/isAllowed')
...
const main = (config) => {
  ...
  const isAllowed = isAllowedModule(config.users)

  const postAndWaitJob = (login, input, params, onReady) => {
